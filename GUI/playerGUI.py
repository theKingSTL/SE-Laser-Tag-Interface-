...
class TeamBoxUI:
    ...
    def handleEvent(self, event):
        ...
        if event.type == pygame.KEYDOWN and self.focusedBox is not None:
            ...
            if event.key == pygame.K_BACKSPACE:
                ...
                #ui = ActionUI(screen, self.database, self.data)
                #ui.draw()
                print("Switching to action screen")
            else:
    ...
    def draw(self):
        ...
        startRect = pygame.Rect(self.width / 2 - 175, self.height - 100, 175, 100)
        ...
        # Render the main text ("Start Game") and center it in the top half of the button
        start_game = self.fontButton.render("Start Game", True, (255,255,255))  # Black text
        start_game_rect = start_game.get_rect(center=(startRect.centerx, startRect.centery - startRect.height // 4))
        ...
        f5_text_rect = f5_text.get_rect(center=(startRect.centerx, startRect.centery + startRect.height // 4))  # Bottom half
        self.screen.blit(f5_text, f5_text_rect)
        self.screen.blit(f5_text, f5_text_rect)

        # Draw reset button with hover effect
        resetRect = pygame.Rect(self.width / 2 + 40, self.height - 100, 175, 100)
